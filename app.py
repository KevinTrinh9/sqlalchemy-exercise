...
def users_show(user_id):
    """Shows a page with info on a specific user"""
...
def posts_show(post_id):
    """Shows a page with info on a specific post"""
...
@app.route('/tags')
def tags_index():
    """Shows a page with info on all tags"""
    tags = Tag.query.all()
...
def tags_show(tag_id):
    """Shows a page with info on a specific tag"""
...
def tags_destroy(tag_id):
    """Handles form submission for deleting an existing tag"""
    tag = Tag.query.get_or_404(tag_id)
